...
/** @var app\modules\caution_refund\models\ApprovalProcess[] $approvals */
                ...
                <div class="cr-steps" style="margin-bottom: 1rem;">
                    ...
                    <?php foreach ($allLevels as $idx => $level): 
                        ...
                        foreach ($approvals as $app) {
                            if ($app->level_id == $level->level_id && strtoupper($app->status) === 'REJECTED') {
                                $isRej = true;
                                break;
                            }
                        }
        ...
        <div class="row">
                                ...
                                <?php foreach ($approvals as $approval): ?>
                                    <div class="cr-timeline-item">
                                        ...
                                        <div style="display: flex; justify-content: space-between;">
                                            <h4 style="font-size: 0.9rem; font-weight: 700; margin: 0;"><?= Html::encode($approval->level->level_name) ?></h4>
                                            <span class="cr-badge cr-badge--approved"><?= Html::encode($approval->status) ?></span>
                                        </div>
                                        ...
                                        <?php if ($approval->comments): ?>
                                            <div class="cr-timeline-comment"><?= Html::encode($approval->comments) ?></div>
                                        <?php endif; ?>
                                    </div>
                                <?php endforeach; ?>
                                <div class="cr-timeline-item">
                                    <div class="cr-timeline-dot" style="border-color: var(--cr-blue-400); animation: pulse 2s infinite;"></div>
                                    <h4 style="font-size: 0.9rem; font-weight: 700; color: var(--cr-blue-600);">Currently At: <?= Html::encode($allLevels[$completedCount]->level_name ?? 'Final Processing') ?></h4>
            ...
            <div class="col-md-4">
                    ...
                    <div class="cr-card__body">
                        ...
                        <div style="border-top: 1px solid var(--cr-blue-50); padding-top: 1rem;">
                            <div style="display: flex; justify-content: space-between; margin-bottom: 0.5rem;">
                                <span style="font-size: 0.7rem; font-weight: 700; color: var(--cr-slate-400); text-transform: uppercase;">Status</span>
                ...
                <div class="alert alert-info" style="background: var(--cr-blue-50); border: none; border-radius: var(--cr-radius); padding: 1.25rem;">
                    ...
                    <p style="font-size: 0.82rem; color: var(--cr-slate-700); line-height: 1.5; margin: 0;">This tracker represents the full administrative path of your caution refund, including both student-facing and internal back-office steps.</p>
                </div>
            </div>
        </div>
    </div>

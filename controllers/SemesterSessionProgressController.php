...
final class SemesterSessionProgressController extends BaseController
{
    ...
    public function actionJoinSession(): Response
    {
        ...
        try {
            $studentSemSessProgress = SmisHelper::studentHasAvailableSessionToJoin(); //dd($studentSemSessProgress);
           ...
           if (!$studentSemSessProgress->save()) {
            ...
            $this->setFlash('success', 'Semester Session',
                'You have successfully reported to your semester session. You may raise and accept this semester\'s invoice here.');

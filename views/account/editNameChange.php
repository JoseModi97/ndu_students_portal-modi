 ...
 * @var string $title
 * @var app\models\NameChange $nameChange
 */
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        <form id="change-name-form" onsubmit="return false" method="post" action="#">
                            ...
                            <input type="text" hidden class="form-control" id="id" name="id" value="<?=$nameChange->name_change_id?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5 col-md-5 col-lg-5">
                                    <input type="text" disabled class="form-control" id="surname" name="surname" value="<?=strtoupper($nameChange->current_surname);?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5 col-md-5 col-lg-5">
                                    <input type="text" disabled class="form-control" id="current-other-names" name="otherNames" value="<?=strtoupper($nameChange->current_othernames);?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5 col-md-5 col-lg-5">
                                    <input type="text" class="form-control" id="new-surname" name="newSurname" value="<?=strtoupper($nameChange->new_surname);?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5 col-md-5 col-lg-5">
                                    <input type="text" class="form-control" id="new-other-names" name="newOtherNames" value="<?=strtoupper($nameChange->new_othernames);?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5 col-md-5 col-lg-5">
                                    <textarea class="form-control" rows="3" id="reason" name="reason"><?=$nameChange->reason?></textarea>
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="document" class="col-sm-3 col-md-3 col-lg-3 offset-md-2 offset-lg-2 text-md-right text-lg-right col-form-label">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-5 col-md-5 col-lg-5 offset-md-5 offset-lg-5">
                                    <button type="submit" id="btn-change-name" class="btn btn-success">Update</button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<?php
$changeNameUrl = Url::to(['/account/update-name-change']);
$requestId = $nameChange->name_change_id;
$nameChangeJs = <<< JS
